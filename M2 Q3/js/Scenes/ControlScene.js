class ControlScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('controls', '../assets/images/titles/controls.png');
        this.load.image('sheet_cont', '../assets/images/titles/controls_sheet.png');
    ...
    create() {
        ...
        // Controls Title
        this.add.image(240,60, 'controls').setScale(0.8);
        this.add.image(240,200, 'sheet_cont');
